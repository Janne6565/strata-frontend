...
export const en = {
  ...
  detail: {
    ...
    backups: "Backups",
    backupsHint:
      "Automatic scheduled snapshots of this database. Download one to keep an offline copy.",
    backupsEmpty: "No backups yet for this database.",
    backupError: "Couldn't load backups for this database.",
    backupCreateError: "Couldn't create the backup.",
    backupName: "Backup",
